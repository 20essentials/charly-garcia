...
const nameBand = 'CHARLY GARCIA';

const nameSongs = [
	"FANKY", /*1*/
	"TU AMOR", /*2*/
	"PROMESAS SOBRE EL BIDET", /*3*/
	"CHIPI CHIPI", /*4*/
	"NOS SIGUEN PEGANDO ABAJO", /*5*/
	"NO VOY EN TREN", /*6*/
	"NO ME DEJAN SALIR", /*7*/
	"CERCA DE LA REVOLUCIÓN", /*8*/
	"ME SIENTO MUCHO MEJOR", /*9*/
	"HABLANDO A TU CORAZÓN", /*10*/
	"INFLUENCIA", /*11*/
	"BUSCANDO UN SÍMBOLO DE PAZ", /*12*/
	"MIENTES", /*13*/
	"REZO POR VOS", /*14*/
	"INCONSCIENTE COLECTIVO", /*15*/
	"DEMOLIENDO HOTELES", /*16*/
	"RAROS PEINADOS NUEVOS", /*17*/
	"LA MÁQUINA DE SER FELIZ", /*18*/
	"ASESINAME", /*19*/
	"DE MÍ", /*20*/
]
